...
module.exports = function (conf, models, needleMock) {
	...
	function list(customerId, fn){
		needle.post(USERS_ENDPOINT + "/search?page.size=1000000", { query: { customer_id: customerId }}, models.webUtil.headers(), function(err, response, body){
